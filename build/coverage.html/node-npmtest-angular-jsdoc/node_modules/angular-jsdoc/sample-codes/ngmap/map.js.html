...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular-jsdoc/node_modules/angular-jsdoc/sample-codes/ngmap/map.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular-jsdoc/node_modules/angular-jsdoc/sample-codes/ngmap/map.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular-jsdoc/node_modules/angular-jsdoc/sample-codes/ngmap/</a> &#187; map.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   *   &lt;/map&gt;
   */
  var map = <span class="fstat-no" title="function not covered" >function(Attr2Options, $timeout, $parse) {</span>
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    var linkFunc = <span class="fstat-no" title="function not covered" >function (scope, element, attrs, ctrl) {</span></span>
      // .. code ..
    };
&nbsp;
